...
//		arr = 65;(X)
		...
		arr[1] = 88;
		arr[2] = arr[0];
//		arr[3] = 3.14; (X)int 배열로 지정했기때문에 double배열을 쓸수 없음
		arr[3] = (int) 3.14; //이건 int 배열로 바꿨기때문에 가능
//		arr[4] = "들어갈까요?" (X)
		arr[4] = 100;
//		arr[5] = 70; (X) index 범위를 초과해서 쓸수 없음
		...
		// 6. 배열의 반복문 처리 
		// 배열은 인덱스 번호로 제어변수로 활용하여 쉽게 반복문을 처리할 수 있습니다.
